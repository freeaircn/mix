...
2 新增
  ...
  使用MYSQL 递归查找数据库Table中的所有父、子节点记录。下一步：继续Doc的 详情，删，修改，预览文件，下载文件。
  
  预览文件页面。下一步：继续Doc的 详情，删，修改，下载文件。
  
  详情页面。下一步：继续Doc的 修改。
  
  已完成：详情页面，修改页面，预览页面，文件上传，下载，删除。下一步：将文件管理同步至其他版块。
  
```

### 4 v1.0.7  2023-5-16 开始
```
  1 升级
    PHP 8.1.19
    CI 4.3.4
