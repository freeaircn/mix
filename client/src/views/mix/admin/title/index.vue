<template>
  <page-header-wrapper>
    <a-card
      ...
      <title-form :visible.sync="visibleForm" :record="tempRecord" @res="handleSave">
      </title-form>
...
<script>
import TitleForm from './modules/TitleForm'
import { getTitleTbl, saveTitle, delTitle } from '@/api/manage'
