<template>
  <page-header-wrapper :title="false">
    <a-card :bordered="false">
      ...
      <politic-form :visible.sync="visibleForm" :record="tempRecord" @res="handleSave">
      </politic-form>
...
<script>
import PoliticForm from './modules/PoliticForm'
import { getPoliticTbl, savePolitic, delPolitic } from '@/api/manage'
...
export default {
  ...
  methods: {
    ...
    loadData () {
      ...
      getPoliticTbl(requestParameters)
        .then(res => {
